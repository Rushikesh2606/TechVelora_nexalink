...
export function AuthProvider({ children }) {
  ...
  async function registerWithEmail(email, password, name, role, extraData = {}) {
    ...
    const profileData = role === 'company' ? {
      ...
      bizVerifyData: extraData.bizVerifyData || null,
      description: '',
      logoUrl: '',
      coverUrl: '',
      website: '',
      verified: !!extraData.bizVerifyData,
      trustScore: extraData.bizVerifyData ? 50 : 10,
      trustBadge: extraData.bizVerifyData ? 'VERIFIED' : 'NEW',
      employeeCount: 0,
      jobsCount: 0,
      postsCount: 0,
      createdAt: Date.now(),
