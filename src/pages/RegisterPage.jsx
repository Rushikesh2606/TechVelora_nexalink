      ...
      >
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleRegister}>
            ...
            <motion.button
              type="button"
              className={`btn btn-secondary btn-lg btn-full enroll-face-btn${
                faceVerified ? ' verified' : ''
              }`}
              style={{
                marginBottom: 12,
                border: faceVerified ? '2px solid #16A34A' : undefined,
                background: faceVerified
                  ? 'linear-gradient(90deg, #16A34A 0%, #7C3AED 100%)'
                  : undefined,
                color: faceVerified ? '#fff' : undefined,
                boxShadow: faceVerified ? '0 0 12px 2px #16A34A44' : undefined,
                position: 'relative',
                overflow: 'hidden',
                transition: 'all 0.3s',
              }}
            ...
            >
              ...
              >
                ...
                {faceVerified ? 'Face Enrolled!' : 'Enroll your face'}
                {faceVerified && (
                  <span style={{ marginLeft: 8, color: '#16A34A', fontSize: 20 }}>
                    ✔️
                  </span>
                )}
              </span>
              ...
              {!faceVerified && (
                <span
                  style={{
                    ...
                    height: '100%',
                    background:
                      'linear-gradient(90deg, #2563EB22 0%, #7C3AED22 100%)',
                    opacity: 0.1,
                    pointerEvents: 'none',
                  }}
                />
            ...
            <button
              ...
              id="register-btn"
              style={{
                opacity: !faceVerified ? 0.6 : 1,
                cursor: !faceVerified ? 'not-allowed' : 'pointer',
              }}
            >
              {loading
                ? '⏳ Creating account...'
                : `Create ${role === 'company' ? 'Company ' : ''}Account`}
            </button>
          </form>
