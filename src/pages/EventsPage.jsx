    ...
    <div className="page-full" style={{ maxWidth: 960, margin: '0 auto' }}>
      ...
      >
        {['all', 'hackathon', 'workshop', 'networking', 'hiring_drive'].map(type => (
          ...
          >
            {type === 'all' ? (
              <><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> All</>
            ) : type === 'hackathon' ? (
              <><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/><line x1="14" y1="4" x2="10" y2="20"/></svg> Hackathons</>
            ) : type === 'workshop' ? (
              <><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a2 2 0 0 1-2.83-2.83l-3.94 3.6Z"/><path d="m14.7 6.3 3 3"/><path d="M15.5 14a2 2 0 1 0-3.48-1.47"/><path d="m10.6 19 .35.35a2 2 0 0 0 2.83 0l3.77-3.77a2 2 0 0 0 0-2.83L16 11.2a2 2 0 0 0-2.83 0l-3.77 3.77a2 2 0 0 0 0 2.83l.2.2"/><path d="m8.6 14.3.4.4"/><path d="m9 9 2 2"/></svg> Workshops</>
            ) : type === 'networking' ? (
              <><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> Networking</>
            ) : (
              <><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg> Hiring Drives</>
            )}
          </button>
        ))}
      </motion.div>
      ...
      {filteredEvents.length === 0 && (
        <EmptyState 
          icon={<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.5 }}><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>} 
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <button className="btn btn-primary" onClick={handleCreateEvent} disabled={creating} id="submit-event-btn" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              {creating ? (
